...
namespace CheatSheet.UI
{
	...
	{
		static Texture2D checkboxTexture = ((CheatSheet)CheatSheet.instance).GetTexture("UI/checkBox");//UIView.GetEmbeddedTexture("Images/UIKit/checkBox");
        static Texture2D checkmarkTexture = ((CheatSheet)CheatSheet.instance).GetTexture("UI/checkMark");//UIView.GetEmbeddedTexture("Images/UIKit/checkMark");
